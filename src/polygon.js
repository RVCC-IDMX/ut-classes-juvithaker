...
class Polygon {
  constructor(sides) {
    this.sides = sides; // Initialize the sides property with the provided array
    this.name = 'Polygon';
  }
   ...
   */
  perimeter() {
    return this.sides.reduce((sum, side) => sum + side, 0); // Calculate and return the perimeter
  }
   ...
   */
  sayName() {
    return this.name; // Return the name of the polygon
  }
}
